...
return [
    ...
    */
    ...
    'stateful' => explode(',', env('SANCTUM_STATEFUL_DOMAINS', sprintf(
        ...
        Illuminate\Support\Env::get('APP_URL') ? ','.parse_url(env('APP_URL'), PHP_URL_HOST) : ''
    ))),
    ...
    */
    ...
    | they have less time to be leaked or stolen. null = never expire.
    |
    */
    ...
    | security scanning initiatives maintained for strings with a known prefix.
    |
    */
